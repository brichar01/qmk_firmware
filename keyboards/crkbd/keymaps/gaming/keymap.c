...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {[0] = LAYOUT_split_3x6_3(
                                                                ...
                                                                XXXXXXX, QK_TRI_LAYER_LOWER, KC_LSFT, KC_SPC, QK_TRI_LAYER_UPPER, XXXXXXX),
                                                              [1] = LAYOUT_split_3x6_3(
                                                                ...
                                                                KC_ESC, OS_LALT, OS_LGUI, OS_LSFT, OS_LCTL, QK_REP, KC_ENT, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_PRINT_SCREEN,
                                                                _______, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), KC_LGUI, KC_PAGE_DOWN, KC_BSPC, KC_DEL, KC_TAB, QK_MOUSE_BUTTON_2, _______,
...
const uint16_t PROGMEM LPRN[]  = {KC_T, KC_S, COMBO_END};
const uint16_t PROGMEM RPRN[]  = {KC_N, KC_E, COMBO_END};
const uint16_t PROGMEM LBRC[]  = {KC_S, KC_R, COMBO_END};
const uint16_t PROGMEM RBRC[]  = {KC_E, KC_I, COMBO_END};
const uint16_t PROGMEM LCBRC[] = {KC_T, KC_R, COMBO_END};
const uint16_t PROGMEM RCBRC[] = {KC_N, KC_I, COMBO_END};

combo_t key_combos[] = {
    COMBO(LPRN, KC_LPRN), COMBO(RPRN, KC_RPRN), COMBO(LBRC, KC_LBRC), COMBO(RBRC, KC_RBRC), COMBO(LCBRC, KC_LCBR), COMBO(RCBRC, KC_RCBR),
};
