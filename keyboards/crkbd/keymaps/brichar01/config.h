...
#    define RGB_MATRIX_LED_FLUSH_LIMIT 50                               // limits in milliseconds how frequently an animation will update the LEDs. 016 (16ms) is equivalent to limiting to 6fps (increases keyboard responsiveness)
